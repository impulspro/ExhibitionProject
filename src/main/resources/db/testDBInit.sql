...
INSERT INTO `exhibition_db_test`.`user` (`id`, `login`, `password`, `role`, `money`) VALUES (DEFAULT, 'Василий', '819b0643d6b89dc9b579fdfc9094f28e', 'user', 1000);
INSERT INTO `exhibition_db_test`.`user` (`id`, `login`, `password`, `role`, `money`) VALUES (DEFAULT, 'Степан', '218dd27aebeccecae69ad8408d9a36bf', 'user', 1000);
INSERT INTO `exhibition_db_test`.`user` (`id`, `login`, `password`, `role`, `money`) VALUES (DEFAULT, 'Дмитро', '218dd27aebeccecae69ad8408d9a363f', 'user', 1500);
...
INSERT INTO `exhibition_db_test`.`exhibition` (`id`, `theme`, `details`, `start_date`, `end_date`, `start_time`, `end_time`, `price`) VALUES (DEFAULT, 'Місто Харків', 'Виставка присвячена місту Харкову', '2022.12.18', '2022.12.28', '09:00:00', '20:00:00', 100);
